...
export PROJECT_NAME=lifebuild-baseball-game
export APP_ENV=development
export DOMAIN_NAME=$APP_ENV.our-stars.com
export SERVER_SUBDOMAIN_NAME=api
export CLIENT_SUBDOMAIN_NAME=www
export GAME_RESULT_SERVER_SUBDOMAIN_NAME=apiresult
export REDIRECTED_FROM_DOMAIN=$CLIENT_SUBDOMAIN_NAME.$DOMAIN_NAME
export REDIRECT_TO_DOMAIN=$DOMAIN_NAME
# SHOULD BE CHANGED for Deployment [END]

# SHOULD NOT BE CHANGED for Deployment [START]
...
# SHOULD NOT BE CHANGED for Deployment [END]
